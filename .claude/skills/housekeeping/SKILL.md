...
| `citations` | A `docs/open-items.md <Letter><N>` citation with no matching `### <ID>` heading |
...
notices. Tracked in `docs/open-items.md` U5, under "The skill's own 77 tests are not run by
any CI step either".
