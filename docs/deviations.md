...
`packages/core/src/pagination/page.ts:114`, `packages/transport-fetch/src/fetch-transport.ts:366`,
`packages/transport-undici/src/undici-transport.ts:674`; the manifest field at `packages/core/package.json:25`,
...
(`packages/transport-fetch/src/fetch-transport.ts:201`, `packages/transport-undici/src/undici-transport.ts:429`).
`transport-fetch` documents having no `proxy` option at all
(`packages/transport-fetch/src/fetch-transport.ts:77-83`). The proxy `challengeHandler` is surfaced with a
