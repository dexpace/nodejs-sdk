...
2. **The collection point.** A deviation found outside a phase, by a review or a maintenance pass, with no
   ...
   and found no unrecorded deviation, only three unrecorded *deferrals* (the dissolved register's U2) and six
   mis-numbered register citations (the dissolved register's U6).
