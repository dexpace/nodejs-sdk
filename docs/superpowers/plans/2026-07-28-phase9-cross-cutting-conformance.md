...
`docs/knowledge/tooling-and-quality-gates.md` — per `docs/superpowers/specs/2026-07-28-phase9-cross-cutting-conformance-design.md`.
...
Add `XCUT-12` to 5c's existing credential-cache single-flight test's header comment (`docs/superpowers/plans/2026-07-26-phase5c-auth.md`'s own test already races N callers on an expiring token). Add `XCUT-22` to 8a's
...
- **design vs styleguide: package manager and lockfile** — RESOLVED in favor of the styleguide (2026-07-25,
  ...
  `docs/superpowers/plans/2026-07-23-scaffold-milestone-checklist.md:54`; the enforcement properties pnpm's
