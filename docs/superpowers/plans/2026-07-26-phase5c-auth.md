...
`docs/superpowers/specs/2026-07-26-phase5c-auth-design.md`. Also closes `PIPE-35`'s `seedFrom`, `AUTH-29`'s
...
- Create: `docs/superpowers/plans/2026-07-26-phase5c-auth-checklist.md`
...
Create `docs/superpowers/plans/2026-07-26-phase5c-auth-checklist.md`, same format as
...
```bash
git add docs/superpowers/plans/2026-07-26-phase5c-auth-checklist.md
