...
`RECOV-17`–`RECOV-34`, per `docs/work/mvp/phase5/phase5a/2026-07-26-phase5a-retry-design.md`.
...
> `docs/work/mvp/phase7/phase7a/2026-07-28-phase7a-configuration-design.md`'s Scope section. This plan's execution now
...
"`Clock` retrofit" note in `docs/work/mvp/phase7/phase7a/2026-07-28-phase7a-configuration-design.md`, Scope section).
...
// points; no other phase depends on them). See docs/work/mvp/phase7/phase7b/2026-07-28-phase7b-observability-design.md's
...
- Create: `docs/work/mvp/phase5/phase5a/2026-07-26-phase5a-retry-checklist.md`
...
Create `docs/work/mvp/phase5/phase5a/2026-07-26-phase5a-retry-checklist.md` in the same format as
...
`docs/work/mvp/2026-07-23-nodejs-sdk-v1-roadmap-design.md`, in the log's existing column shape:
...
```bash
git add docs/work/mvp/phase5/phase5a/2026-07-26-phase5a-retry-checklist.md \
  docs/work/mvp/2026-07-23-nodejs-sdk-v1-roadmap-design.md
