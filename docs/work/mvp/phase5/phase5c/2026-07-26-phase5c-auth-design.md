...
design](../phase5b/2026-07-26-phase5b-redirect-design.md)), 5c (this document, auth). 5c also closes items the roadmap's
...
5c consumes) plus **the [Phase 5b design](../phase5b/2026-07-26-phase5b-redirect-design.md) itself**, which is the actual
