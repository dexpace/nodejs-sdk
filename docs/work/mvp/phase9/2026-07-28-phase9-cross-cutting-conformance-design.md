...
`docs/product-spec/appendix-b-conformance-test-checklist.md` (§B.8, §B.9), `docs/work/mvp/2026-07-23-nodejs-sdk-v1-roadmap-design.md`
(Deferred Items Log), `docs/work/mvp/2026-07-25-checkpoint-scaffold-through-phase3a.md` (the one prior
