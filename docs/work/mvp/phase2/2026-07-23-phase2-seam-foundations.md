...
`docs/work/mvp/phase2/2026-07-23-phase2-seam-foundations-design.md`.
...
**Spec coverage** (every requirement ID in `docs/work/mvp/phase2/2026-07-23-phase2-seam-foundations-design.md`'s
