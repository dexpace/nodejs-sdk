...
```bash
git add packages/core/src/index.ts packages/core/src/index.public.test.ts packages/core/src/sse/lifecycle.test.ts packages/core/etc/core.api.md .changeset/phase6b-sse.md docs/work/mvp/2026-07-23-nodejs-sdk-v1-roadmap-design.md
