...
Generated. The two-tree contract, and why nothing here is hand-edited, is in `../README.md`.
...
| pagination | `pagination.md` | 61 | design, spec | 1 | 2026-07-25 |
...
38 topic files, 1457 entries — 1451 in the type sections plus
6 conflict statements. A conflict statement records what two documents each say; its
resolution, where one exists, is a note under `../notes/`.
